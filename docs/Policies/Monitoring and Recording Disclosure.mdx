...
The delivery of the updated opening should feel a bit more natural. You may jump right into your dialogue right
afterwards. We no longer require mentioning the possibility of the call being monitored since all calls are recorded
by default.

To ensure compliance, it is <Highlight color="#ff2600">MANDATORY</Highlight> for **ALL CCC Team Members** taking or making a call to provide the updated
disclosure.
...
Failure to provide Monitoring/Recording Disclosure at the beginning of **ALL** calls will result in disciplinary ac
ons.
